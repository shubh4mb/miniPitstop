...
export const updateUser = async (user) => {
    try {
        ...
        //('Error updating user details:', error);
        throw error;
    }
};
...
export const filteredProducts = async (filterTerm , page , limit) => {
  try {
    ...
    //('Error fetching filtered products:', error);
    throw error;
  }
};
...
export const getCartProducts = async () => {
  try {
    ...
    //('Error fetching cart products:', error);
    throw error;
  }
};
...
export const updateCartItemQuantity = async (itemId, newQuantity) => {
  try {
    ...
    //('Error updating cart item quantity:', error);
    throw error;
  }
};
...
export const fetchAllAvailableCoupons = async () => {
  try {
    ...
    //('Error fetching available coupons:', error);
    throw error;
  }
};
...
export const verifyRazorpayPayment = async (paymentData) => {
  try {
    ...
    //('Error verifying Razorpay payment:', error);
    throw error;
  }
};
...
export const placeFailedOrder = async (orderData) => {
  try {
    ...
    //('Error placing failed order:', error);
    throw error;
  }
};
...
export const createRazorpayWallet = async (amount) => {
  try {
    ...
    //('Error creating Razorpay wallet order:', error);
    throw error;
  }
};
...
export const verifyRazorpayWallet = async (verifyData) => {
  try {
    ...
    //('Error verifying Razorpay wallet payment:', error);
    throw error;
  }
};
...
export const createRetryRazorpayPayment = async (orderId) => {
  try {
    ...
    //('Error retrying Razorpay payment:', error);
    throw error;
  }
}
...
export const relatedProducts = async ( filterTerm) => {
  try{
    ...
    //('Error fetching related products:', error);
    throw error;
  }
}
...
export const getFeaturedProducts = async () => {
  try {
    ...
    //('Error fetching featured products:', error);
    throw error;
  }
}
