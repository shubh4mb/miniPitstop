    ...
    <nav className="user-glass-effect  my-2 p-4 text-gray-600 relative z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          <span onClick={() => navigate('/home')} className="hover:text-red-600 transition-colors font-medium">Home</span>
          <span onClick={() => navigate('/shop')} className="hover:text-red-600 transition-colors font-medium">Shop</span>
          <div className="relative">
            <input
              type="text"
              placeholder="Search products..."
              className="pl-10 pr-10 py-2 rounded-full bg-white/50 backdrop-blur-sm border border-gray-200 focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-200 transition-all w-64"
          ...
          <Link to="/profile/wishlist" className="hover:text-red-600 transition-colors flex items-center space-x-1 font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
            </svg>
            <span>Wishlist</span>
          </Link>
          <Link to="/profile/cart" className="hover:text-red-600 transition-colors flex items-center space-x-1 font-medium">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="relative">
            ...
            >
              ...
              <span>{fullName? fullName : 'Account'}</span>
            </button>
            {dropdownOpen && (
